...
userBean.setShowHidden("False");
String xml = "<Data>"; 

requestBean.setMyaction("Create");
requestBean.setMyobject("Transaction");
...
conditionBean.setFieldNames("Name");
conditionBean.setConditionNames("Special");
conditionBean.setConditionValues("False");
conditionBean.setOptionName("Unique");
conditionBean.setOptionValue("True");
...
<c:set var="xslfilename">list_transaction.xsl</c:set>
