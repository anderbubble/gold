...
userBean.setUserAction("create_quotation");
...
requestBean.setMyobject("Quotation");
requestBean.setMyaction("createQuotation");

userBean.setUserAction("");
%>

<c:set var="xmltext"><%=xml%></c:set>
<c:set var="xslfilename">create_quotation.xsl</c:set>
