...
userBean.setUserAction("create_reservation");
userBean.setShowHidden(null);
String xml = "<Data></Data>"; //+ requestBean.getInputXML(userBean);

//get ready to create a project: bean uses this when doAction is called from results.jsp
requestBean.setMyobject("Reservation");
requestBean.setMyaction("Create");
//requestBean.setMyaction("createReservation");//no longer need special method, can use default create stuff

userBean.setUserAction("");
%>

<c:set var="xmltext"><%=xml%></c:set>
<c:set var="xslfilename">create_reservation.xsl</c:set>
